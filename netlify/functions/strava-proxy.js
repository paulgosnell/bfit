// Netlify Function: Proxy Strava webhook to Supabase Edge Function, adding Authorization header
exports.handler = async (event) => {
  const supabaseProjectRef = "ibginimdnezoftxxygvt";
  const base = `https://${supabaseProjectRef}.functions.supabase.co/strava-webhook`;
